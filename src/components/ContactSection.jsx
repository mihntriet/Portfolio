        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-text-primary">
              <span className="text-neon-orange">&gt;</span> command_center
            </h2>
            <div className="flex-1 h-px bg-gradient-to-r from-neon-orange/30 to-transparent" />
          </div>
          <p className="text-text-secondary text-sm max-w-2xl">
            Access operations interface. Transmit signals directly via radar uplink or execute local CLI queries.
          </p>
        </motion.div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start w-full">
          
          {/* LEFT SIDE (Radar & Form): lg:col-span-5 */}
          ...
          {/* RIGHT SIDE (Terminal Console): lg:col-span-7 */}
          <div className="lg:col-span-7 w-full">
            <InteractiveConsole hideHeader={true} />
          </div>
